...
<div class="sidebar_top">
	<h5><?php echo esc_html__( 'Boost your tables to the next level', 'multiple-products-to-cart-for-woocommerce' ); ?></h5>
...
<div class="site-intro">
	<h5><?php echo esc_html__( 'Missing any features? No worries!', 'multiple-products-to-cart-for-woocommerce' ); ?></h5>
...
<div class="mpca_sidebar">
	<h5><?php echo esc_html__( 'Dedicated Support Team', 'multiple-products-to-cart-for-woocommerce' ); ?></h5>
	<div class="tagline_side">
