	...
	<div id="mpcdp_settings" class="mpcdp_container">
		<div id="mpcdp_settings_page_header">
			...
			<div id="mpcdp_toolbar_icons">
				<a class="mpcdp-tippy" target="_blank" href="<?php echo esc_url( $mpc__['plugin']['docs'] ); ?>" data-tooltip="<?php echo esc_html__( 'Documentation', 'multiple-products-to-cart-for-woocommerce' ); ?>">
