...
if ( ! class_exists( 'MPCTable' ) ) {
	...
	class MPCTable {
		...
		public function product_data( $id, $product ) {
			...
			$data['images'][$thumb] = !file_exists( $data['images'][$thumb] ) ? $mpctable__['default_imgs']['thumb'] : $data['images'][$thumb];
			$data['images'][$full]  = !file_exists( $data['images'][$full] ) ? $mpctable__['default_imgs']['thumb'] : $data['images'][$full];
